...
\begin{figure}[H]
	\centering\includegraphics[scale=0.75]{captures/gantt.pdf}
...
%poner tabla con los dos entrenamientos de PPO2
...
%Poner tabla de dos experimentos de POO2 con 100 millones de iteraciones.

\begin{figure}[H]
	\centering\includegraphics[scale=0.25]{mario/definitivoRecompensas.png}
...
\begin{figure}[H]
	\centering\includegraphics[scale=0.25]{mario/definitivoEpisodios.png}
...
\begin{figure}[H]
	\centering\includegraphics[scale=0.25]{mario/definitivoNube.png}
	\caption{Nube de puntos entre media de recompensas y duración de episodios (pasos) durante entrenamiento de 10 millones de interacciones con A2C y PPO2 en \textit{SuperMarioBros-Nes}.}
	\label{fig:marioPPO22nube} % Unique label used for referencing the figure in-text
	%\addcontentsline{toc}{figure}{Figure \ref{fig:sigmoide}} % Uncomment to add the figure to the table of contents
\end{figure}
